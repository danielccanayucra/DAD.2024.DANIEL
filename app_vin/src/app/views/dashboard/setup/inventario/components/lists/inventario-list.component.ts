                ...
                <div class="p-2 overflow-scroll px-0">
                    <table class="w-full table-fixed">
                        ...
                        <tr>
                            ...
                            <th class="w-1/6 table-header text-center border-r">Marca</th>
                            <th class="w-1/6 table-header text-center border-r">Codigo</th>
                            <th class="w-1/6 table-header text-center border-r">Proveedor Id</th>
                            <th class="w-2/6 table-header text-center">Acciones</th>
                        </tr>
                        </thead>
                        <tbody class="bg-white" *ngFor="let r of inventarios; let i = index">
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="w-2/6 p-2 text-start border-b text-sm">{{ r.stock }}</td>
...
export class InventarioListComponent implements OnInit {
    ...
    this.isDetalleVisible = new Array(this.inventarios.length).fill(false);
    }
